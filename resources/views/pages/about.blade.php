...
<div class="container">
  ...
  <p>
    {{ config('app.name') }} is a clone app of <a href="https://laramaps.com" target="_blank">Laramap.com.</a>
  </p>
  ...
  <p>
    Feel free to help to improve the <a href="https://github.com/koularambaye/{{ config('app.name') }}-tdn" target="_blank">source code</a>.
  </p>
